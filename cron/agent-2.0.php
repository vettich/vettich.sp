<?php
// THIS FILE - DOCUMENT_ROOT/bitrix/modules/vettich.autopostingplus/cron/agent-2.0.php
...
use vettich\autopostingplus\Module;
use vettich\autopostingplus\Pending;
