...
class postTable extends DBase
{
    ...
    public static function getMap()
    {
        $arMap = array(
            ...
            (new ArrayField('IBLOCK_SECTIONS', ['default_value' => []]))->configureSerializationPhp(),
            ...
            (new ArrayField('CONDITIONS', ['default_value' => []]))->configureSerializationPhp()->addValidator(new LengthValidator(0, 2000)),
            ...
            (new ArrayField('WEEK', ['default_value' => []]))->configureSerializationPhp(),
            (new ArrayField('MONTH', ['default_value' => []]))->configureSerializationPhp(),
