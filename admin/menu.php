...
if (\COption::GetOptionString('vettich.sp', 'show_promo_v3', 'Y') == 'Y') {
    $aMenu['items'][] = array(
        'text'		=> GetMessage('VettichSPMenu_PromoV3'),
        'url'		=> '/bitrix/admin/vettich.sp.promo_v3.php',
        'items_id' 	=> 'vettich_sp_promo_v3',
    );
}
